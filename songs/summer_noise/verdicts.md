# AI記述への採点 (summer_noise)

| 項目 | AIの主張 | 判定 |
|---|---|---|
| ハーフタイム(実質64.6BPM) | describe.py(耳+定規) | ○ |
| ボーカル=女性ウィスパー | 耳(2回目) | × 男性 |
| コード進行 Cm7-Fm7-B♭7-E♭maj7 | 耳(2回目) | △ 家族は近いがFの性別とトニックを外す |
| キー=Cマイナー | 定規KS法+耳 | × 正解はB♭メジャー |
